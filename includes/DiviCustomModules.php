		...
		$this->builder_localize_script = array(
			'i10n' => array(
				'dicm_cta_all_options' => array(
					...
					'gallery'              => esc_html__( 'Gallery', 'dicm-divi-custom-modules' ),
					'gallery_ids'          => esc_html__( 'Gallery IDs', 'dicm-divi-custom-modules' ),
					'gallery_orderby'      => esc_html__( 'Gallery Orderby', 'dicm-divi-custom-modules' ),
					'gallery_captions'     => esc_html__( 'Gallery Captions', 'dicm-divi-custom-modules' ),
					'rendered_gallery'     => esc_html__( 'Rendered gallery', ''),
					'advanced_fields'      => esc_html__( 'Advanced Fields', 'dicm-divi-custom-modules' ),
					'address'              => esc_html__( 'Address', 'dicm-divi-custom-modules' ),
					'zoom_level'           => esc_html__( 'Zoom Level', 'dicm-divi-custom-modules' ),
					'address_lat'          => esc_html__( 'Address Lat', 'dicm-divi-custom-modules' ),
					'address_lan'          => esc_html__( 'Address Lan', 'dicm-divi-custom-modules' ),
					'map_center'           => esc_html__( 'Map Center', 'dicm-divi-custom-modules' ),
